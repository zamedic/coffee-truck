  ...
  module Helpers
    module Unit
      ...
      def current_unit_coverage(node)
        ...
        {coverage: ((coverage*1000).round / 1000.0).to_f, max_complexity: complexity_max, average_complexity: ((((complexity_sum.to_f / complexity_sum.to_f) * 100).round)/100.0).to_f}
      end
